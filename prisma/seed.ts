...
const superTasks = [
  ...
  "Double-Check Metropolis Security Systems",
  "Join Batman for Crime Fighting Collaboration",
...
const wonderTasks = [
  ...
  "Send Thank You Note to Steve Trevor",
  "Practice Epic Pose for Next Battle",
  "Check on Amazonian Training Camp",
